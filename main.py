...
mainFont = pygame.font.SysFont('sans-serif', 30)
...
class Character:
    def __init__(self, value, position, visible=False):
        self.value = value
...
word = getRandomWord()
testRender = mainFont.render(word, True, colorText)
